        ...
        <form action="{{ route("admin.students.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('student_gender') ? 'has-error' : '' }}">
                ...
                @foreach(App\Student::STUDENT_GENDER_RADIO as $key => $label)
                    <div>
                        <input id="student_gender_{{ $key }}" name="student_gender" type="radio" value="{{ $key }}" {{ old('student_gender', null) === (string)$key ? 'checked' : '' }} required>
            ...
            <div class="form-group {{ $errors->has('student_linkedin_profile') ? 'has-error' : '' }}">
                ...
                <input type="url" id="student_linkedin_profile" name="student_linkedin_profile" class="form-control" value="{{ old('student_linkedin_profile', isset($student) ? $student->student_linkedin_profile : '') }}">
            ...
            <div class="form-group {{ $errors->has('student_github_profile') ? 'has-error' : '' }}">
                ...
                <input type="url" id="student_github_profile" name="student_github_profile" class="form-control" value="{{ old('student_github_profile', isset($student) ? $student->student_github_profile : '') }}" required>
